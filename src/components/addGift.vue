<template>
    <div>
        <div class="vip-card">
            <div class="open-vip" v-if="showCanvas" @click="addGiftPic(index)">
                <div>+添加活动图片</div>
            </div>
            <img v-if="!showCanvas" @click="addGiftPic(index, giftImgSrc)" :src="giftImgSrc" style="width:600rpx;height:300rpx;" />
        </div>
