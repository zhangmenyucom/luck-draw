    ...
    stat: function() {
      if (MTA_CONFIG.app_id != '') {
        ...
        for (var d = c.length; b < d; b++)
          for (var e in c[b]) c[b].hasOwnProperty(e) && a.push(e + '=' + (typeof c[b][e] === 'undefined' ? '' : c[b][e]));
        wx.request({
    ...
    stat: function(a, b) {
      if (MTA_CONFIG.event_id != '') {
        ...
        for (e = d.length; f < e; f++)
          for (var h in d[f]) d[f].hasOwnProperty(h) && c.push(h + '=' + (typeof d[f][h] === 'undefined' ? '' : d[f][h]));
        wx.request({
